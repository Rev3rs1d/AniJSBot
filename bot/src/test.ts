...
( async () => {
  ...
  animes.description = 'Steins;Gate reconta os fatos desde o 23 alternativo em Steins;Gate em que Okabe falha ao salvar Makise Kurisu'
  animes.genre = 'Sci-Fi'
  animes.year = 1
  animes.id_anilist = 21127
  animes.anilist_link = 'https://anilist.co/anime/21127/SteinsGate-0'
  animes.image_url = 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/bx21127-7ARWZkDXKiiD.jpg'
